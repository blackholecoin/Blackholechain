...
cp $TRAVIS_BUILD_DIR/src/qt/Blackholechain-qt $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/qt/Blackholechain-qt.exe $OUTDIR/bin/ || echo "no QT Wallet"
cp $TRAVIS_BUILD_DIR/src/Blackholechaind $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/Blackholechaind.exe $OUTDIR/bin/
cp $TRAVIS_BUILD_DIR/src/Blackholechain-cli $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/Blackholechain-cli.exe $OUTDIR/bin/
cp $TRAVIS_BUILD_DIR/src/Blackholechain-tx $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/Blackholechain-tx.exe $OUTDIR/bin/
