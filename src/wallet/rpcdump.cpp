...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"blackholechainprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"blackholechainprivkey\"   (string, required) The private key (see dumpprivkey)\n"
...
UniValue importaddress(const UniValue& params, bool fHelp)
{
    ...
    if (address.IsValid()) {
        ...
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Blackholechain address or script");
    }
...
UniValue importwallet(const UniValue& params, bool fHelp)
{
    ...
    while (file.good()) {
        ...
        if(vstr[0] == "sigma=1"){
            ...
            SigmaEntry.denomination = stoi(vstr[2]);
            ...
            pwalletMain->NotifyZerocoinChanged(pwalletMain, SigmaEntry.value.GetHex(), "New (" + std::to_string(SigmaEntry.denomination) + " mint)", CT_NEW);
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"blackholechainaddress\"\n"
            "\nReveals the private key corresponding to 'blackholechainaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"blackholechainaddress\"   (string, required) The Blackholechain address for the private key\n"
            "\nResult:\n"
