...
std::string LicenseInfo() {
    const std::string URL_SOURCE_CODE = "<https://github.com/Blackholechain/Blackholechain/>";
    const std::string URL_WEBSITE = "<https://www.ssc.moe/>";
...
void InitLogging() {
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Blackholechain version %s\n", FormatFullVersion());
}
...
//    LogPrintf("PrivateSend amount %d\n", nPrivateSendAmount);
    ...
    // ********************************************************* Step 11c: update block tip in Blackholechain modules
