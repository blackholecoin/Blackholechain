...
UniValue exodus_decodetransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw std::runtime_error(
            "exodus_decodetransaction \"rawtx\" ( \"prevtxs\" height )\n"

            "\nDecodes an Exodus transaction.\n"
            ...
            "  \"fee\" : \"n.nnnnnnnn\",             (string) the transaction fee in blackholechains\n"
            "  \"sendingaddress\" : \"address\",     (string) the Blackholechain address of the sender\n"
            "  \"referenceaddress\" : \"address\",   (string) a Blackholechain address used as reference (if any)\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_decodetransaction", "\"\" \"[{\\\"txid\\\":\\\"eeafb8c5b3be663f2ad0c00597a88f2896765b2ae30735791c7e476dce14af63\\\",\\\"vout\\\":1,\\\"scriptPubKey\\\":\\\"76a9149084c0bd89289bc025d0264f7f23148fb683d56c88ac\\\",\\\"value\\\":0.0001123}]\"")
            + HelpExampleRpc("exodus_decodetransaction", "\"\", [{\"txid\":\"eeafb8c5b3be663f2ad0c00597a88f2896765b2ae30735791c7e476dce14af63\",\"vout\":1,\"scriptPubKey\":\"76a9149084c0bd89289bc025d0264f7f23148fb683d56c88ac\",\"value\":0.0001123}]")
        );
...
UniValue exodus_createrawtx_opreturn(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            "exodus_createrawtx_opreturn \"rawtx\" \"payload\"\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("exodus_createrawtx_opreturn", "\"01000000000000000000\" \"00000000000000020000000006dac2c0\"")
            + HelpExampleRpc("exodus_createrawtx_opreturn", "\"01000000000000000000\", \"00000000000000020000000006dac2c0\"")
        );
...
UniValue exodus_createrawtx_multisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 4)
        throw std::runtime_error(
            "exodus_createrawtx_multisig \"rawtx\" \"payload\" \"seed\" \"redeemkey\"\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("exodus_createrawtx_multisig", "\"0100000001a7a9402ecd77f3c9f745793c9ec805bfa2e14b89877581c734c774864247e6f50400000000ffffffff01aa0a0000000000001976a9146d18edfe073d53f84dd491dae1379f8fb0dfe5d488ac00000000\" \"00000000000000020000000000989680\" \"1LifmeXYHeUe2qdKWBGVwfbUCMMrwYtoMm\" \"0252ce4bdd3ce38b4ebbc5a6e1343608230da508ff12d23d85b58c964204c4cef3\"")
            + HelpExampleRpc("exodus_createrawtx_multisig", "\"0100000001a7a9402ecd77f3c9f745793c9ec805bfa2e14b89877581c734c774864247e6f50400000000ffffffff01aa0a0000000000001976a9146d18edfe073d53f84dd491dae1379f8fb0dfe5d488ac00000000\", \"00000000000000020000000000989680\", \"1LifmeXYHeUe2qdKWBGVwfbUCMMrwYtoMm\", \"0252ce4bdd3ce38b4ebbc5a6e1343608230da508ff12d23d85b58c964204c4cef3\"")
        );
...
UniValue exodus_createrawtx_input(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "exodus_createrawtx_input \"rawtx\" \"txid\" n\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("exodus_createrawtx_input", "\"01000000000000000000\" \"b006729017df05eda586df9ad3f8ccfee5be340aadf88155b784d1fc0e8342ee\" 0")
            + HelpExampleRpc("exodus_createrawtx_input", "\"01000000000000000000\", \"b006729017df05eda586df9ad3f8ccfee5be340aadf88155b784d1fc0e8342ee\", 0")
        );
...
UniValue exodus_createrawtx_reference(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
            "exodus_createrawtx_reference \"rawtx\" \"destination\" ( amount )\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("exodus_createrawtx_reference", "\"\" \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\" 0.005")
            + HelpExampleRpc("exodus_createrawtx_reference", "\"\", \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\", 0.005")
        );
...
UniValue exodus_createrawtx_change(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 4 || params.size() > 5)
        throw std::runtime_error(
            "exodus_createrawtx_change \"rawtx\" \"prevtxs\" \"destination\" fee ( position )\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("exodus_createrawtx_change", "\"\" \"[{\\\"txid\\\":\\\"6779a710fcd5f6fb0883ea3306360c3ad8c0a3c5de902768ec57ef3104e65eb1\\\",\\\"vout\\\":4,\\\"scriptPubKey\\\":\\\"76a9147b25205fd98d462880a3e5b0541235831ae959e588ac\\\",\\\"value\\\":0.00068257}]\" \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\" 0.00003500 1")
            + HelpExampleRpc("exodus_createrawtx_change", "\"\", [{\"txid\":\"6779a710fcd5f6fb0883ea3306360c3ad8c0a3c5de902768ec57ef3104e65eb1\",\"vout\":4,\"scriptPubKey\":\"76a9147b25205fd98d462880a3e5b0541235831ae959e588ac\",\"value\":0.00068257}], \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\", 0.00003500, 1")
        );
...
{ //  category                         name                          actor (function)             okSafeMode
  //  -------------------------------- ----------------------------- ---------------------------- ----------
    { "exodus (raw transactions)", "exodus_decodetransaction",     &exodus_decodetransaction,     true },
    { "exodus (raw transactions)", "exodus_createrawtx_opreturn",  &exodus_createrawtx_opreturn,  true },
    { "exodus (raw transactions)", "exodus_createrawtx_multisig",  &exodus_createrawtx_multisig,  true },
    { "exodus (raw transactions)", "exodus_createrawtx_input",     &exodus_createrawtx_input,     true },
    { "exodus (raw transactions)", "exodus_createrawtx_reference", &exodus_createrawtx_reference, true },
    { "exodus (raw transactions)", "exodus_createrawtx_change",    &exodus_createrawtx_change,    true },
