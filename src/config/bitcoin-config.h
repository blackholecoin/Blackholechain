...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Blackholechain Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Blackholechain Core"
...
#define PACKAGE_BUGREPORT "https://github.com/BlackholechainOfficial/Blackholechain//issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Blackholechain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Blackholechain Core 4.0.9"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Blackholechain"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://ssc.moe/"
