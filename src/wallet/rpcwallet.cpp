...
// Copyright (c) 2009-2016 The Blackholechain Core developers
...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new Blackholechain address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"blackholechainaddress\"    (string) The new Blackholechain address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current Blackholechain address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"blackholechainaddress\"   (string) The account Blackholechain address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Blackholechain address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"blackholechainaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"blackholechainaddress\"  (string, required) The Blackholechain address to be associated with an account.\n"
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Blackholechain address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"blackholechainaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"blackholechainaddress\"  (string, required) The Blackholechain address for account lookup.\n"
            "\nResult:\n"
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"blackholechainaddress\"  (string) a Blackholechain address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "sendtoaddress \"blackholechainaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"blackholechainaddress\"  (string, required) The Blackholechain address to send to.\n"
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"blackholechainaddress\",     (string) The Blackholechain address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"blackholechainaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"blackholechainaddress\"  (string, required) The Blackholechain address to use for the private key.\n"
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"blackholechainaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given blackholechainaddress in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"blackholechainaddress\"  (string, required) The Blackholechain address for transactions.\n"
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"toblackholechainaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a Blackholechain address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"       (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"toblackholechainaddress\"  (string, required) The Blackholechain address to send funds to.\n"
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The Blackholechain address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Blackholechain address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a Blackholechain address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of Blackholechain addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) Blackholechain address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"blackholechainaddress\"  (string) A Blackholechain address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"blackholechainaddress\",    (string) The Blackholechain address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"blackholechainaddress\",    (string) The Blackholechain address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"blackholechainaddress\",   (string) The Blackholechain address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 2))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending blackholechains\n"
            "\nArguments:\n"
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"blackholechainaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "wallet encrypted; Blackholechain server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue settxfee(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("settxfee", "0.00000001 BHC")
            + HelpExampleRpc("settxfee", "0.00000001 BHC")
        );
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of Blackholechain addresses to filter\n"
            "    [\n"
            "      \"address\"   (string) Blackholechain address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the Blackholechain address\n"
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Blackholechain address: ")+input.get_str());
            if (setAddress.count(address))
...
UniValue fundrawtransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"     (string, optional, default pool address) The Blackholechain address to receive the change\n"
    ...
    if (params.size() > 1) {
      if (params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid Blackholechain address");
...
UniValue regeneratemintpool(const UniValue &params, bool fHelp) {
    ...
    if(reindexRequired)
        return "Mintpool issue corrected. Please shutdown Blackholechain and restart with -reindex flag.";

    return "No issues with mintpool detected.";
}

//Blackholechain: sigma section
...
UniValue spend(const UniValue& params, bool fHelp) {
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw std::runtime_error(
            "spend \"address\" amount ( \"comment\" subtractfeefromamount )\n"
            "\nSpend sigma and remint changes in a single transaction to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"address\"  (string, required) The address to spend to.\n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("spend", "\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XZ\" 10")
            + HelpExampleCli("spend", "\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XZ\" 10 \"tax\" \"payment\"")
            + HelpExampleCli("spend", "\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XZ\" 10 \"\" \"\" true")
            + HelpExampleRpc("spend", "\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XZ\", 10, \"tax\", \"payment\"")
        );
...
UniValue spendmany(const UniValue& params, bool fHelp) {
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw std::runtime_error(
                ...
                "5. subtractfeefromamount   (string, optional) A json array with addresses.\n"
                "                           The fee will be equally deducted from the amount of each selected address.\n"
                "                           Those recipients will receive less blackholechains than you enter in their corresponding amount field.\n"
                "                           If no addresses are specified here, the sender pays the fee.\n"
                "    [\n"
                "      \"address\"            (string) Subtract fee from this address\n"
                "      ,...\n"
...
UniValue listsigmamints(const UniValue& params, bool fHelp) {
    ...
    BOOST_FOREACH(const CSigmaEntry &SigmaItem, listPubcoin) {
        if (fAllStatus || SigmaItem.IsUsed || (SigmaItem.randomness != uint64_t(0) && SigmaItem.serialNumber != uint64_t(0))) {
            ...
            entry.push_back(Pair("ecdsaSecretKey", HexStr(SigmaItem.ecdsaSecretKey)));
            results.push_back(entry);
        }
    }
...
UniValue listsigmapubcoins(const UniValue& params, bool fHelp) {
    ...
    std::string help_message =
        "listsigmapubcoins <all>(1/5/10/50/100/500/1000/5000)\n"
            "\nArguments:\n"
            "1. <all> (string, optional) 1, 5, 10, 50, 100, 500, 1000, 5000 (default) to return all sigma public coins with given denomination. empty to return all pubcoin.\n"
            "\nResults are an array of Objects, each of which has:\n"
            "{id, IsUsed, denomination, value, serialNumber, nHeight, randomness}";
    if (fHelp || params.size() > 1) {
...
{ //  category              name                        actor (function)           okSafeMode
    ...
    //{ "wallet",             "dumpprivkey",              &dumpprivkey_gxx,          true  },
    //{ "wallet",             "dumpwallet",               &dumpwallet_gxx,           true  },
