...
WalletView::WalletView(const PlatformStyle *platformStyle, QWidget *parent):
    ...
    blackholechainTransactionsView(0),
...
{
    // Create Blackholechain transactions list
    ...
    // Create export panel for Blackholechain transactions
    ...
    blackholechainTransactionsView = new QWidget();
    blackholechainTransactionsView->setLayout(coinLayout);
    ...
    if (isExodusEnabled()) {
        ...
        transactionTabs->addTab(blackholechainTransactionsView, tr("Blackholechain"));
    ...
    if (transactionTabs) {
        ...
        pageLayout->addWidget(blackholechainTransactionsView);
    }
...
{
    sendBlackholechainView = new SendCoinsDialog(platformStyle);

    connect(sendBlackholechainView, SIGNAL(message(QString, QString, unsigned int)), this, SIGNAL(message(QString, QString, unsigned int)));
    ...
    if (isExodusEnabled()) {
        ...
        sendCoinsTabs->addTab(sendBlackholechainView, tr("Blackholechain"));
    ...
    if (sendCoinsTabs) {
        ...
        pageLayout->addWidget(sendBlackholechainView);
    }
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    sendBlackholechainView->setClientModel(clientModel);
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    sendBlackholechainView->setModel(walletModel);
...
void WalletView::gotoSendCoinsPage(QString addr)
{
    ...
    if (!addr.isEmpty()){
        sendBlackholechainView->setAddress(addr);
    }
}
...
bool WalletView::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    ...
    return sendBlackholechainView->handlePaymentRequest(recipient);
}
