...
const token_rule_t routerdesc_token_table[] = {
  ...
  T01("onion-key-crosscert", K_ONION_KEY_CROBHCERT, NO_ARGS, NEED_OBJ ),
  T01("ntor-onion-key-crosscert", K_NTOR_ONION_KEY_CROBHCERT,
                                                    EQ(1),   NEED_OBJ ),
                               ...
                               int *can_dl_again_out)
{
...

  {
    ...
    cc_tap_tok = find_opt_by_keyword(tokens, K_ONION_KEY_CROBHCERT);
    cc_ntor_tok = find_opt_by_keyword(tokens, K_NTOR_ONION_KEY_CROBHCERT);
    ...
    if (ed_sig_tok) {
      ...
      if (strcmp(cc_tap_tok->object_type, "CROBHCERT")) {
