...
std::string exodus::strMPProperty(uint32_t propertyId)
{
    ...
    if (0x80000000 & propertyId) {
        ...
        switch (propertyId) {
            case EXODUS_PROPERTY_BHC: str = "BHC";
                break;
...
{
    if ((EXODUS_PROPERTY_BHC != propertyId) && !isTestEcosystemProperty(propertyId)) return true;
...
int input_mp_offers_string(const std::string& s)
{
    ...
    if (EXODUS_PROPERTY_BHC != prop_desired) return -1;
