...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Blackholechain wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private Q_SLOTS:
    ...
    /** Switch directly to Blackholechain history tab */
